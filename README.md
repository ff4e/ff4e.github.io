...
| `subtitleDom.ts` | 1.9 k | PROTOTYPE: the room's subtitles as DOM text, animated by the compositor. Off unless the dev bar's Subtitles picker (or `__ff.setSubRenderer('dom')`) selects it. |
