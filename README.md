...
*32 regions over 5808 lines. Generated from the `//#region` markers in
...
| 5332–5808 | `window.__ff` host | `debugHooks` | The 144-member host the debug hooks read the game through: getters, plus eleven setters for the values probes deliberately write. The hooks themselves are in `debugHooks.ts`. |
