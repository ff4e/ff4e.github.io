...
await withApp(async ({ p, expect }) => {
  ...
  const openCredits = async (tier) => {
    ...
    await p.waitForFunction(() => window.__ff.screen() === 'map', { timeout: 8000 });
  ...
  }, undefined, { timeout: 20000 }).then(() => stripEl()).catch(() => null);
