...
await p
  .waitForFunction(() => document.getElementById('screen-gl').style.display === 'none')
  .catch(() => {});
...
await p.waitForFunction(() => document.getElementById('screen-gl').style.display === 'none').catch(() => {});
